...
export class DashboardComponent implements OnInit {
  ...
  getCountCoachs(){
    this.statService.getCoachs().subscribe(
    data=>this.AllCoachs=data.length
    )
    console.log(this.AllCoachs)
  }
  getCountMembers(){
    this.statService.getMembers().subscribe(
    data=>this.AllMembers=data.length
    )
    console.log(this.AllMembers)
  }
  getCountAbonnements(){
    this.statService.getAbonnements().subscribe(
    data=>this.AllAbonnements=data.length
    )
    console.log(this.AllAbonnements)
  }
  getCountReservations(){
    this.statService.getReservations().subscribe(
    data=>this.AllReservations=data.length
    )
